...
| **Ruta del café** | Escribes una ciudad o barrio y arma una ruta a pie por 4–6 cafeterías de especialidad reales, con link de Google Maps para toda la ruta y para cada parada. | `POST /api/ruta` con OpenAI y **búsqueda web**; solo quedan paradas con fuente citada; el puntaje solo si una fuente lo publica; caché de 24 h por lugar en SQLite y topes por visitante y diarios. |
